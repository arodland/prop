...
# Boulder, Wallops, Juliusruh, Austin, Dourbes, Hermanus
stations = [11, 61, 10, 1, 12, 26]
...
def grad(x):
    ...
    ret = 0
    ds['gp'].set_parameter_vector(p)
    ret -= ds['gp'].grad_log_likelihood(ds['y'], quiet=True)
...
if __name__=='__main__':
    ...
    opt_result = op.minimize(nll, p0, jac=grad_nll, method='TNC', callback=cb, options={'maxiter': 100})
